package com.example.s3_bucket_integration.service;
...
public class StorageService {
    ...
    public String uploadFile(String folderName, MultipartFile file) {
        ...
        return "File uploaded to: " + folderName + "/" + file.getOriginalFilename();
    }
    ...
    public String deleteFile(String folderName, String fileName) {
        ...
        return fileName + " removed from folder " + folderName;
    }
